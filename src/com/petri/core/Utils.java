...
public class Utils 
{
	...
	public static final Logger logTest = Logger.getAnonymousLogger();
	public static final Logger logEstados = Logger.getAnonymousLogger();
	public static final Logger logSensibilizadas = Logger.getAnonymousLogger();
